...
class PatrullasDorsal extends \FPDF {
	...
	public function genera($participantes) {
		...
		foreach ($participantes as $participante) {
			...
			$this->Cell(21,$ancho,$participante['patrulla_numero'],$borde,0,'C',$relleno);
	...
	public function Header() {
            ...
            $this->Ln();
            $this->SetFont('Arial','B',10);
            $this->Cell(290,5,'LISTADO PATRULLAS POR DORSAL',0,0,'C');
            $this->Ln();
			...
			$this->Cell(21,$ancho,utf8_decode('Nº PATRULLA'),$borde,0,'C',$relleno);
