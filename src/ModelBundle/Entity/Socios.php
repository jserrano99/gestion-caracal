...
class Socios
{
    ...
    /**
     * @var \ModelBundle\Entity\Personas
     */
    private $persona;

    /**
     * @var \ModelBundle\Entity\Estados
     */
    private $estado;
     ...
     * @return Socios
     */
    public function setPersona(\ModelBundle\Entity\Personas $persona = null)
    {
     ...
     * @return Socios
     */
    public function setEstado(\ModelBundle\Entity\Estados $estado = null)
    {
        $this->estado = $estado;
